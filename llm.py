...
def extract_articles_summary(model, articles: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    prompt = (
        "You are an article summarizer tasked with extracting topics and summaries out of articles given to you. You cannot output triple backticks and you only output pure, valid JSON.\n"
...
def extract_comparative_sentiment_score(model, articles: List[Dict[str, Any]]) -> ComparativeSentimentScore:
    ...
    prompt = (
        "You are an article analyzer tasked with creating a comparative analysis out of articles given to you. You cannot output triple backticks and you only output pure, valid JSON.\n"
